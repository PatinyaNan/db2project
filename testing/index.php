            ...
            $.get('fetch.php', (data) => {
                ...
                const html = fetchData.rows.map((a, b) => {
                    return '<tr id="item-'+a.ID_ADDITIONAL+'">\n\
                        ...
                        <td>\n\
                            <center><button type="button" onclick="window.handleUpdate(\''+a.ID_ADDITIONAL+'\')" class="btn btn-warning btn-xs update" id="product-edit-'+a.ID_ADDITIONAL+'" data-row-id="'+a.ID_ADDITIONAL+'"><span class="fa fa-pencil-square-o"></span>&nbsp;&nbsp;Edit</button>\n\
                            <button type="button" onclick="window.handleDelete(\''+a.ID_ADDITIONAL+'\')" class="btn btn-danger btn-xs delete" id="product-delete-'+a.ID_ADDITIONAL+'" data-row-id="'+a.ID_ADDITIONAL+'"><span class="fa fa-trash-o"></span>&nbsp;&nbsp;Delete</button></center>\n\
                        </td>\n\
                    </tr>';
               ...
               <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <label>Enter Promotion</label>
                            <input type="text" name="ID_CATEGORY" id="ID_CATEGORY" class="form-control" /><br />
                        <label>Enter Insurace Category</label>
