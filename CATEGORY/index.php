        ...
        $(document).ready(function(){
            ...
            $.get('fetch.php', (data) => {
                ...
                const html = fetchData.rows.map((a, b) => {
                    return '<tr id="item-'+a.ID_CATEGORY+'">\n\
                        <td>'+String(a.ID_CATEGORY)+'</td>\n\
                        <td>'+a.CA_NAME+'</td>\n\
                        <td>\n\
                            <center><button type="button" onclick="window.handleUpdate(\''+a.ID_CATEGORY+'\')" class="btn btn-warning btn-xs update" id="product-edit-'+a.ID_CATEGORY+'" data-row-id="'+a.ID_CATEGORY+'"><span class="fa fa-pencil-square-o"></span>&nbsp;&nbsp;Edit</button>\n\
                            <button type="button" onclick="window.handleDelete(\''+a.ID_CATEGORY+'\')" class="btn btn-danger btn-xs delete" id="product-delete-'+a.ID_CATEGORY+'" data-row-id="'+a.ID_CATEGORY+'"><span class="fa fa-trash-o"></span>&nbsp;&nbsp;Delete</button></center>\n\
                        </td>\n\
                    </tr>';
    ...
    <body>
        <div class="container box">
            <div class="pull" align="right">
                <h1 align="center"><b>ระบบการจัดการประเภทประกันภัย</b></h1>
            </div>
          ...
          <form method="post" id="product_form">
               <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <label>ID Category Insurance</label>
                            <input type="text" name="ID_CATEGORY" id="ID_CATEGORY" class="form-control" value='<?php echo $id_category;?>' disabled/><br />
                        <label>Enter Name Category</label>
                            <input type="text" name="CA_NAME" id="CA_NAME" class="form-control" /><br />
                    </div>
